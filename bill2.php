...
if($bill_info['cnt'] > 0){
    ...
    $bill_in_price = $bill_in_price_arr[$ho_indx] != '' ? $bill_in_price_arr[$ho_indx] : '0';

    // echo $ho_indx;
    // print_r($bill_in_price_arr);
    ...
    $bill_penulty = $bill_penulty_arr[$ho_indx] != '' ? $bill_penulty_arr[$ho_indx] : '0';

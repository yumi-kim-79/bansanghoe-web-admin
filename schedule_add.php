        ...
        <form action="">
            ...
            <div class="inner">
                ...
                <ul class="regi_list">
                    ...
                    <li>
                        <?php
                        $sql_building = "SELECT mng_b.*, mng.mng_name, mng.mng_department, 
                                         depart.md_name, mng_grade.mg_name FROM
                                        ...
                                        WHERE mng_b.is_del = 0 and mng.mng_department = '{$cal_row['mng_department']}' GROUP BY mng.mng_department ";
                        ...
                        <div class="ipt_box ipt_flex ipt_box_ver2">
                            <div class="bansang_sel_box">
                                ...
                                <?php }else{ ?>
                                    <select name="mng_department" id="mng_department" class="bansang_sel" onchange="department_change();">
                                    ...
                                    <script>
                                        function department_change(){
                                            ...
                                            url : "/schedule_add_mng_ajax.php", //ajax 통신할 파일
                                            type : "POST", // 형식
                                            data: {"departmentValue":departmentValue}, //파라미터 값
                                            success: function(msg){ //성공시 이벤트
                            ...
                            <?php
                            $sql_building2 = "SELECT mng.*, mng_gr.mg_name FROM a_mng as mng
                                                LEFT JOIN a_mng_grade as mng_gr on mng_gr.mg_idx = mng.mng_grades
                                                WHERE mng.mng_department = '{$cal_row['mng_department']}' ORDER BY mng.mng_idx desc ";
                            //echo $sql_building;
                            // exit;
                            ...
                            <div class="bansang_sel_box">
                                ...
                                <?php if($w == 'i'){
                                    $mngs = get_manger($cal_row['mng_id']);
                                ?>
                                    <input type="text" name="mng_name" class="bansang_ipt ver2" value="<?php echo $cal_row['mng_id'] == '-1' ? '전체' :  $mngs['mng_name']; ?>" readonly>
                                <?php }else{ ?>
                                    <select name="mng_id" id="mng_id" class="bansang_sel">
                                        ...
                                        ?>
                                        <option value="<?php echo $row_building2['mng_id']; ?>" <?php echo get_selected($cal_row['mng_id'], $row_building2['mng_id']); ?>><?php echo $row_building2['mng_name'].' '.$row_building2['mg_name'];?></option>
                                        <?php }?>
                                    </select>
                                <?php }?>
                    ...
                    <li>
                        ...
                        <div class="ipt_box ipt_flex">
                            ...
                            <div class="building_name_box <?php echo $w == 'i' ? 'ver2' : ''; ?>">
                    ...
                    <li>
                        ...
                        <div class="ipt_box">
                            <input type="text" name="cal_date" id="cal_date" class="bansang_ipt <?php echo $w == 'i' ? '' : 'ipt_date'; ?>  ver2" readonly value="<?php echo $cal_row['cal_date']; ?>">
                        </div>
                    </li>
                    <li>
                        ...
                        <?php if($w == 'i'){
                            ...
                            ?>
                            <input type="text" name="noti_repeat_name" class="bansang_ipt ver2" value="<?php echo $noti_repeat_t; ?>" readonly>
                        <?php }else{ ?>
                ...
                <ul class="regi_list ver2">
                    <li>
                        ...
                        <div class="ipt_box">
                            <input type="text" name="cal_title" id="cal_title" class="bansang_ipt ver2" placeholder="제목을 입력하세요." value="<?php echo $cal_row['cal_title']; ?>" <?php echo $w == 'i' ? 'readonly' : '';?>>
                        </div>
                    </li>
                    <li>
            ...
            <div class="fix_btn_box flex_ver ver3">
                ...
                <?php }else if($w == 'i'){ ?>
                    ...
                    <button type="button" class="fix_btn <?php echo $cal_row['is_process'] ? '' : 'on'?>" id="fix_btn" onclick="popOpen('schedule_process_pop');" <?php echo $cal_row['is_process'] ? 'disabled' : ''?>>처리완료</button>
...
function scheduleDelHandler(){
    ...
    let sendData = {cal_idx:cal_idx, mb_id:mb_id};

    $.ajax({
        type: "POST",
        url: "/schedule_add_del.php",
        data: sendData,
        cache: false,
        async: false,
        dataType: "json",

...
<form name="frmcontentform" action="./contentformupdate.php" onsubmit="return frmcontentform_check(this);" method="post" enctype="MULTIPART/FORM-DATA">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" value="<?php echo $co['co_id']; ?>" name="co_id" id="co_id" required <?php echo $readonly; ?> class="bansang_ipt ver2" size="20" maxlength="20">
                ...
                <tr>
                    ...
                    <td><input type="text" name="co_subject" value="<?php echo htmlspecialchars2($co['co_subject']); ?>" id="co_subject" required class="bansang_ipt ver2" size="90"></td>
                </tr>
                <tr>
                    <th scope="row">내용</th>
    ...
    <div class="btn_fixed_top">
        ...
        <input type="submit" value="확인" class="btn btn_submit btn_02" accesskey="s">
    </div>

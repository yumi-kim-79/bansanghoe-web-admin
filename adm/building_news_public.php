...
if($_GET['type'] == 'progress'){
    $sql_search = " where (1) and bb.is_del = '0' and bb.bbs_type = 'public' and bb.is_before = 0 ";
}else{
    $sql_search = " where (1) and bb.is_del = '0' and bb.bbs_type = 'public' and bb.is_before = 1 ";
}
...
$g5['title'] = $_GET['type'] == "progress" ? "공문(관공서)" : "공문(이전자료)";
                ...
                ?>
                    ...
                    <tr class="<?php echo $bg; ?>">
                        ...
                        <td headers="mb_list_mng" class="td_mng td_mng_s">
                            <a href="./building_news_public_form.php?type=<?php echo $type;?>&<?=$qstr;?>&amp;w=u&amp;bb_id=<? echo $row['bb_id']; ?>" class="btn btn_03">관리</a>
                        </td>
                    </tr>
                <?php
                }

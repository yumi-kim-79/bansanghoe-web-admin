...
<form name="fconfigform" id="fconfigform" method="post" onsubmit="return fconfigform_submit(this);">
    ...
    <section id="anc_cf_basic">
        <h2 class="h2_frm ver2">신반상회 기본설정</h2>
        <!-- <?php echo $pg_anchor ?> -->
        ...
        <div class="tbl_frm01 tbl_wrap">
            <table>
                ...
                <tbody>
                    <tr>
                        <th scope="row"><label for="cf_title">상호명<strong class="sound_only">필수</strong></label></th>
                        <td colspan="3"><input type="text" name="cf_title" value="<?php echo get_sanitize_input($config['cf_title']); ?>" id="cf_title" required class="bansang_ipt ver2" size="40"></td>
                    </tr>
                    <tr>
                        <th>대표자</th>
                        <td colspan="3"><input type="text" name="cf_1" value="<?php echo $config['cf_1']; ?>" class="bansang_ipt ver2"></td>
                    </tr>
                    <tr>
                        <th>사업자 등록번호</th>
                        <td colspan="3"><input type="text" name="cf_2" value="<?php echo $config['cf_2']; ?>" class="bansang_ipt ver2"></td>
                    </tr>
                    <tr>
                        <th>주소</th>
                        <td colspan="3"><input type="text" name="cf_3" value="<?php echo $config['cf_3']; ?>" class="bansang_ipt ver2" size="100"></td>
                    </tr>
                    <tr>
                        <th>회원가입/회원탈퇴 설정</th>
                        <td colspan="3">
                            <?php echo help("앱 심사에 사용되는 부분입니다. 앱 심사 완료 후에는 미노출로 변경해주세요."); ?>
                            <div class="radio_chk_wrap">
                                <div class="radio_chk_box">
                                    <input type="radio" name="cf_4" id="cf_41" value="Y" <?php echo $config['cf_4'] == 'Y' ? 'checked' : '';?>>
                                    <label for="cf_41">노출</label>
                                </div>
                                <div class="radio_chk_box">
                                    <input type="radio" name="cf_4" id="cf_42" value="N" <?php echo $config['cf_4'] == 'N' ? 'checked' : '';?>>
                                    <label for="cf_42">미노출</label>
                                </div>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <select name="cf_editor" id="cf_editor" class="bansang_sel">
                                <?php
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <textarea name="cf_possible_ip" id="cf_possible_ip" class="bansang_ipt ver2 ta full"><?php echo get_sanitize_input($config['cf_possible_ip']); ?></textarea>
                        </td>
                        <th scope="row"><label for="cf_intercept_ip">접근차단 IP</label></th>
                        <td>
                            <?php echo help('입력된 IP의 컴퓨터는 접근할 수 없음.<br>123.123.+ 도 입력 가능. (엔터로 구분)') ?>
                            <textarea name="cf_intercept_ip" id="cf_intercept_ip" class="bansang_ipt ver2 ta full"><?php echo get_sanitize_input($config['cf_intercept_ip']); ?></textarea>
                        </td>
                    </tr>
                    <tr style="display:none;">
    ...
    <section id="anc_cf_cert" style="display:none;">
    ...
    <section id="anc_cf_mail" style="display:none;">
    ...
    <section id="anc_cf_article_mail" style="display:none;">
    ...
    <section id="anc_cf_join_mail" style="display:none;">
    ...
    <section id="anc_cf_sms" style="display:none;">
    ...
    <section id="anc_cf_extra" style="display:none;">
    ...
    <div class="btn_fixed_top btn_confirm">
        <input type="submit" value="확인" class="btn_submit btn btn_02" accesskey="s">
    </div>

...
$sql = "select ho.*, building.building_id as bid, building.building_name, dong.dong_name, post.post_name from a_building_ho as ho
...
<button type="button" onclick="sch_handler('<?php echo $row['building_name']; ?>', '<?php echo $row['bid']; ?>')"><?php echo $row['building_name']; ?></button>
<?php }?>
...
if($mng_infos['mng_certi'] != 'D'){
    ...
    // or sign_off.mng_id = '{$mb_ids}' ) 
    // $sql_search = " WHERE sign_off.is_del = 0 and (( sign_off.sign_off_mng_id1 = '{$mb_ids}' or sign_off.sign_off_mng_id2 = '{$mb_ids}' or sign_off.sign_off_mng_id3 = '{$mb_ids}') or sign_off.mng_id = '{$mb_ids}'  )";

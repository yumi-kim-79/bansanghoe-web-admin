...
$building_id = $_POST['building_ids'] ?? '';

$building_info = get_builiding_info($building_id);
    ...
    <div class="news_content">
        ...
        <div class="new_info_hd">
            <p class="news_number">
                ...
                <span class="news_number_box1"><?php echo $_POST['bb_numbers'];?></span>
            </p>
            <p class="news_number news_number2 news_number_r">
                <span class="news_number_label">게 시 기 한</span>
                <span class="news_number_box2"><?php echo $_POST['bbs_gigan'] ? '영 구 게 시' : $_POST['edates'].'까지';?></span>
            </p>
        </div>
      
        <p class="news_tit_box"><?php echo $_POST['title']; ?></p>

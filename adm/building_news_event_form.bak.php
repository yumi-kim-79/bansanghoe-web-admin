        ...
        <table>
            ...
            <tbody>
                    ...
                    <td>
                        ...
                        <script>
                            function building_change(){
                                ...
                                let sendData = { 'post_id':post_id, 'building_id': buildingValue, 'bbs_type':'event'};
                ...
                <tr>
                    <th>제목</th>
                    <td colspan="3">
                        <input type="text" name="bb_title" class="bansang_ipt ver2" size="100" value="<?php echo $row['bb_title']; ?>">
                    </td>
                </tr>
                <tr>
                    <th>내용</th>

...
<div class="tbl_frm01 tbl_wrap">
    ...
    <table>
        <tr>
            <th>작성일</th>
            <td colspan="3"><input type="text" name="wdate" id="wdate" class="bansang_ipt <?php echo $verCl;?> ipt_date" value="<?php echo date("Y-m-d");?>" required <?php echo $w == "u" ? "disabled" : ""?>></td>
        </tr>
        <tr>
            <th>작성자</th>
            <td>
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <div class="sign_off_selector">
                    ...
                    ?>
                        <input type="hidden" name="sign_off_mng_id1" id="sign_off_mng_id3" value="<?php echo $row['sign_off_mng_id1'];?>" class="bansang_ipt" readonly>
        ...
        <tr>
            <th>연장근무일시</th>
            <td colspan="3"><input type="text" name="extension_date" id="extension_date" class="bansang_ipt <?php echo $verCl;?> ipt_date" value="<?php echo $row['extension_date']; ?>" required></td>
        </tr>
        <tr>
            <th>시작 시간</th>
            <td>
                <div class="ipt_box flex_ver">
                    <!-- readonly -->
                    <input type="text" name="extension_stime" id="extension_stime" class="bansang_ipt <?php echo $verCl;?>" value="<?php echo $row['extension_stime']; ?>" placeholder="00:00"  required maxlength='5' oninput="this.value = this.value.replace(/[^0-9:]/g, '')">
                    <!-- <select name="extension_stime1" class="bansang_sel">
                        <option value="">선택</option>
                    </select>
                    <select name="extension_stime2" class="bansang_sel">
                        <option value="">선택</option>
                    </select> -->
                </div>
            </td>
            ...
            <td>
                <div class="ipt_box flex_ver">
                    <!-- readonly -->
                    <input type="text" name="extension_etime" id="extension_etime" class="bansang_ipt <?php echo $verCl;?>" value="<?php echo $row['extension_etime']; ?>" placeholder="00:00" required maxlength='5' oninput="this.value = this.value.replace(/[^0-9:]/g, '')">
                    <!-- <select name="extension_etime1" class="bansang_sel">
                        <option value="">선택</option>
                    </select>
                    <select name="extension_etime2" class="bansang_sel">
                        <option value="">선택</option>
                    </select> -->
                </div>
            </td>
        ...
        <tr>
            <th>내용</th>
            <td colspan="3">
                <textarea name="sign_off_memo" id="sign_off_memo" class="bansang_ipt <?php echo $verCl;?> ta full" <?php echo $readonlys;?>><?php echo $row['sign_off_memo']; ?></textarea>
            </td>
        </tr>
        <tr>
            <th>신청자 서명</th>
    ...
    <?php if($selectValue == "overtime_work_request"){?>
        <p class="certi_texts">위 내용으로 연장 근무를 신청합니다.</p>
    <?php }else if($selectValue == "overtime_work_report"){?>
        <p class="certi_texts">위의 연장근무 내역이 사실임을 확인합니다.</p>
    <?php }?>
</div>

<script>
let selectValue = "<?php echo $selectValue; ?>";
$(function(){

    if(selectValue == "overtime_work_request"){

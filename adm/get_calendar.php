...
$sql_where = " and is_del = 0 ";
if($calcode != "schedule"){
    $sql_where .= " and is_del = 0 and cal_code = '{$calcode}' and cal_date like '{$now_month}%' ";
}
...
//추가 반복일정 가져오기
$sql2 = "SELECT * FROM a_calendar WHERE is_del = 0 and noti_repeat != 'N'";
$res2 = sql_query($sql2);
...
foreach ($res2 as $r) {
    if($r['noti_repeat'] == "MONTH"){
        ...
        array_push($month_arr, $date_month);
    }

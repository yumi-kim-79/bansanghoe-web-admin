...
.sign_img_box {width: 100px;height: 80px;position:relative;box-sizing:border-box;padding-bottom:18px;display: flex;align-items:center;justify-content:center;}

...
if($ex_approver1 == "") die(result_data(false, "최초 관리단 결재자를 선택해주세요.", 'ex_approver1'));
...
if($w == "u"){
    ...
    if($expense_row['ex_apprval1_chk']) die(result_data(false, "결재가 진행된 품의서는 수정이 불가능합니다.", 'N'));
...
//die(result_data(false, $insert_query, $upload));
...
.bill_due_info_wrap > div {width: 57%;min-height: 177px;}
...
.bill_due_box .due_box {height: calc(177px / 6);padding-left: 80px;display: flex;align-items:center;font-size: 10px;}
...
.bpage2_topbottom {height:530px;}
.bpage2_top {height: 443px;padding-top: 30px;}
...
.bpage2_no_due {margin-top: 8px;display: flex;font-size: 11px;padding-top: 41px;}
.bpage2_no_due > div {width: 50%;text-align: center;height: 27px;display: flex;align-items:center;justify-content:center;}

.bpage2_no_due_sum_wrap {margin-top: 3px;display: flex;justify-content:flex-end;}
...
.building_notice_wrap {margin-top: 13px;height: 175px;padding: 35px 15px 0;}
...
.bill_last_left_box {height: 28px;display: flex;align-items:center;padding-left: 75px;justify-content:center;}
.bill_last_right_box {height: 37.3px;padding-top: 11px;display: flex;align-items:center;justify-content:center;font-size: 11px;}
            ...
            <div class="bill_dear_box">
                ...
                <!-- 수신 주소 -->
                 ...
                 <?php
                    ...
                    echo $addr.'<br>'.$building_info['building_name'].' '.$dong_name.' '.$ho_info['ho_name'].' '.$ho_info['ho_tenant'].' 귀하';
                ?>
                 </div>
            </div>
        </div>

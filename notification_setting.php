...
if($types == "sm"){
    ...
    if($user_info['noti1'] == "1"){
        $noti1 = "checked";
    }

    if($user_info['noti2'] == "1"){
        $noti2 = "checked";
    }

    if($user_info['noti3'] == "1"){
        $noti3 = "checked";
    }

    if($user_info['noti4'] == "1"){
        $noti4 = "checked";
    }

    if($user_info['noti5'] == "1"){
        $noti5 = "checked";
    }

    if($user_info['noti6'] == "1"){
        $noti6 = "checked";
    }

    if($user_info['noti7'] == "1"){
        $noti7 = "checked";
    }
}
?>
...
$("#switch_all").click(function () {
  console.log($("#switch_all").is(":checked"));
...
$(document).ready(function () {
    $(".switch_chk").change(function () {
        let isChecked = $(this).prop("checked");  // 체크 여부
        let name = $(this).attr("name");  // 체크박스 name 속성

        let mb_id = "<?php echo $types == "sm" ? $member['mb_id'] : $user_info['mb_id']; ?>";
        console.log(name + " : " + isChecked); // 값 확인용

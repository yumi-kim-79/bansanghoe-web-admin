...
- [x] **1차 검색 시 지역/단지 드롭다운 자동 채움 + 동/호수 숫자만 표기** (2026-03-30)
  - 1차 검색 결과 1개 단지: 지역/단지 드롭다운 자동 선택, 동 목록 자동 채움
  - 1차 검색 결과 여러 단지: 단지 드롭다운에 매칭 단지만 표시
  - 동/호수 컬럼에서 "동", "호" 텍스트 제거 (숫자만 표기)

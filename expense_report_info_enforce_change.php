...
if($enforce_deaprt == "") die(result_data(false, "부서를 선택해주세요.", []));
if($enforce_grade == "") die(result_data(false, "직급을 선택해주세요.", []));
if($enforce_id == "") die(result_data(false, "시행자를 선택해주세요.", []));
...
//die(result_data(false, $expense_row['enforce_id']."/".$enforce_id, $expense_row));
...
$msg = $w == 'u' ? '시행자가 변경되었습니다.' : '시행자가 등록되었습니다.';
